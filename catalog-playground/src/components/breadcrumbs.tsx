...
const BreadcrumbSeparator = forwardRef<HTMLSpanElement, React.ComponentPropsWithoutRef<'span'>>(
  ({ className, children, ...props }, ref) => (
    <span ref={ref} role="presentation" aria-hidden className={cn('text-outline-subtle select-none', className)} {...props}>
      {children ?? '/'}
    </span>
  )
);
