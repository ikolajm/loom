...
const toggleVariants = cva(
  'inline-flex items-center justify-center interactive cursor-pointer transition-colors control data-[state=off]:bg-transparent data-[state=off]:text-on-surface-variant data-[state=off]:border-outline data-[state=off]:border data-[state=on]:bg-primary-container data-[state=on]:text-on-primary-container data-[state=on]:border-primary-container data-[state=on]:border',
  {
    variants: {
      size: {
