    ...
    return (
      <DayPicker
        ...
        classNames={{
          ...
          button_previous: cn('inline-flex shrink-0 items-center justify-center rounded-component interactive cursor-pointer control', navSize),
          button_next: cn('inline-flex shrink-0 items-center justify-center rounded-component interactive cursor-pointer control', navSize),
          month_grid: 'w-full',
          ...
          day_button: cn('inline-flex w-full h-full items-center justify-center interactive cursor-pointer control', cellSize),
