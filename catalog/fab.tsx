  ...
  'inline-flex items-center justify-center font-medium tracking-[0.01em] interactive focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      ...
      size: {
        ...
        'ext-sm': 'h-ch-4 px-3 gap-2 rounded-card shadow-[var(--shadow-2)] text-[12px] leading-[16px]',
        'ext-md': 'h-ch-6 px-4 gap-2 rounded-card shadow-[var(--shadow-3)] text-[14px] leading-[20px]',
        'ext-lg': 'h-ch-8 px-5 gap-3 rounded-card shadow-[var(--shadow-3)] text-[16px] leading-[24px]',
      },
    },
    defaultVariants: {
      variant: 'default',
